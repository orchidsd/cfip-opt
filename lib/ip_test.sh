...
ip_list_mirrors() {
    ...
    if [[ "$ip_version" == "ipv6" ]]; then
        ...
        echo "https://raw.githubusercontent.com/XIU2/CloudflareSpeedTest/master/ip.txt"
        echo "https://raw.gitmirror.com/XIU2/CloudflareSpeedTest/master/ip.txt"
        echo "https://ghproxy.net/https://raw.githubusercontent.com/XIU2/CloudflareSpeedTest/master/ip.txt"
    fi
}
...
ip_list_update() {
    ...
    while IFS= read -r url; do
        ...
        rm -f "$f.tmp"
    done <<< "$(ip_list_mirrors "$ip_version")"
